...
import likePost from "./_actions/LikeScore";
...
export default async function Blog() {
    ...
    return (
        <>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
                {posts.map((post) => (
                    ...
                    >
                        ...
                        <LikeButton id={post.id} likePost={likePost} initialLikes={0} />
                        {user ? (
                            <>
                                <Link
                                    href={{
            ...
            <Link href="/blog/new" className="border-2 border-black p-2 m-2 rounded-lg">
                New
            </Link>
            <Link href="/blog/user" className="border-2 border-black p-2 m-2 rounded-lg">
                User
            </Link>
            <Link href="/" className="border-2 border-black p-2 m-2 rounded-lg">
                Home
            </Link>
        </>
    );
